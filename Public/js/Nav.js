const createNav = () =>{
    ...
    <div class="nav-items">
        ...
        <div class="search">
         ...
         <a>
         <img src="./img/cart.png" id="cart-icon" alt="">
         <div class="cart">
           <h2 class="cart-title" id="cart-title">add to whislist</h2>

            <div class="cart-content">
               <div class="cart-box">
                  <img src="./img/card1.png" id="cart-img" alt="">
...
<ul class="links-container">
    ...
    <li class="link-item"><a href="/femme" class="link">Femmes</a></li>
    <li class="link-item"><a href="/homme" class="link">Hommes</a></li>
    <li class="link-item"><a href="/enfant" class="link">Enfants</a></li>
    <li class="link-item"><a href="/accessoires" class="link">Accessoires</a></li>
</ul>
